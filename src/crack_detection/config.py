...
class DetectorConfig:
    ...
    grid_kernel_size: int = 25
    grid_kernel_response: float = 0.55
    grid_orientation_tolerance: float = 20.0
    grid_axis_ratio_threshold: float = 4.0
    grid_perimeter_area_threshold: float = 0.18
    grid_line_angle_variance: float = 28.0
    grid_density_kernel_size: int = 25
    grid_density_threshold: float = 0.45
    grid_dense_overlap: float = 0.4
